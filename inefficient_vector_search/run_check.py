...
embeddings = tf.convert_to_tensor(np.load("/Users/qiao/ResearchHelper/inefficient_vector_search/Hot_dog_encodings.npy"), tf.float32)
...
if __name__ == '__main__':
    ...
    with open("/Users/qiao/ResearchHelper/inefficient_vector_search/Hot_dog_sentences.txt", 'r') as sentence_file:
